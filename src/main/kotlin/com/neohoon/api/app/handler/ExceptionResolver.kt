package com.neohoon.api.app.handler
...
class ExceptionResolver(
    ...
    @ExceptionHandler(NeohoonBaseException::class)
    fun resolveNeohoonException(
        ex: NeohoonBaseException,
        locale: Locale
    ) = getProblemDetail(ex.status, ex.code, locale).also { log.debug("neohoonException resolved : {}", ex.javaClass) }
